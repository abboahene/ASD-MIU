...
public class Application {
	...
	public static void main(String[] args) {
		...
		Predicate<Customer> fromChicago = (c) -> c.getAddress().getCity().equals("Chicago");
		Iterator<Customer> filterCityIterator = customerCollection.getfilterIterator(fromChicago);
		while(filterCityIterator.hasNext()){
			System.out.println(filterCityIterator.next());
		}

		System.out.println("--------------filter by zip----------------");
		Predicate<Customer> zipStartWith12 = (c) -> c.getAddress().getZip().startsWith("12");
		Iterator<Customer> filterZipIterator = customerCollection.getfilterIterator(zipStartWith12);
		while(filterZipIterator.hasNext()){
			System.out.println(filterZipIterator.next());
		}
